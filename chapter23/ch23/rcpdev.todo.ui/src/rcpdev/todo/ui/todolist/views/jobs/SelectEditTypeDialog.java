...
public class SelectEditTypeDialog extends Dialog {
	 ...
	 * @param parentShell
	 */
	public SelectEditTypeDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		promptLabel
				.setText("You are about to edit an item in a series,\n please choose the action you want to perform");
		...
		editThisOccurenceButton.setText("Edit this occurence");
		...
		editTheSeriesButton.setText("Edit the series");
